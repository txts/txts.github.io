...
As to the second point, in the following:

+ SE is _not_ some mathematical exercise where perfect axioms are translated to perfect code;
+ Software construction is _not_ some
